...
/* ─── Text Swap (roles) ─────────────────────────────────────────────────── */
const ROLES = ['Full-Stack Developer', 'MERN Stack Engineer', 'Spring Boot Developer', 'API Architect', 'React.js Developer'];
const TextSwap = () => {
        ...
        {mobileOpen && (
          <motion.div
            ...
            style={{
              ...
              gap: 16, boxShadow: '0 12px 32px rgba(0,0,0,0.08)'
            }}
          >
            {NAV_LINKS.map(l => (
              <motion.a
            ...
            <motion.button
              ...
              style={{
                ...
                borderRadius: 100, padding: '0.875rem 1.5rem', fontSize: '0.9rem',
...
const Hero = ({ onContact }) => {
  ...
  return (
    <section style={{
      ...
      padding: 'clamp(80px, 10vh, 120px) clamp(16px, 4vw, 80px) 60px',
        ...
        <div className="hero-grid">
          ...
          <motion.div variants={stagger} initial="hidden" animate="show">
            ...
            <motion.p variants={item} style={{
              ...
              Full-Stack Developer with hands-on experience in end-to-end web application development using <strong style={{ fontWeight: 600, color: 'var(--ink)' }}>MERN stack</strong>, <strong style={{ fontWeight: 600, color: 'var(--ink)' }}>Spring Boot</strong> &amp; <strong style={{ fontWeight: 600, color: 'var(--ink)' }}>Go</strong>.
              Building scalable RESTful APIs, JWT/RBAC security systems, and production-ready web applications across e-commerce, travel booking, and service management domains.
   ...
   <motion.div
              ...
              >
                <div style={{
                  ...
                  <div className="avatar-fallback" style={{
                    ...
                    <span className="font-display" style={{ fontSize: 'clamp(3rem, 10vw, 4.5rem)', color: 'var(--gold-dk)', opacity: 0.5 }}>DR</span>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                style={{
                  ...
                  boxShadow: '0 8px 32px rgba(0,0,0,0.15)', willChange: 'transform', whiteSpace: 'nowrap'
                }}
                className="avatar-badge"
              >
                <Code2 size={12} style={{ color: 'var(--gold)' }} /> MERN
              </motion.div>
              ...
              <motion.div
                ...
                style={{
                  ...
                  background: 'linear-gradient(135deg, var(--gold-dk), var(--gold))',
                  color: 'var(--cream)', borderRadius: 100, padding: '0.45rem 1rem',
                  display: 'flex', alignItems: 'center', gap: 5,
                  fontSize: '0.72rem', fontWeight: 600, letterSpacing: '0.05em',
                  boxShadow: '0 8px 32px rgba(184,151,90,0.3)', willChange: 'transform', whiteSpace: 'nowrap'
                }}
                className="avatar-badge"
              >
              ...
              <motion.div
                ...
                style={{
                  position: 'absolute', bottom: '38%', right: '-48px',
              ...
              >
                ...
                <span style={{ fontSize: '0.6rem', color: 'var(--ink-80)', letterSpacing: '0.05em', marginTop: 2 }}>Projects</span>
              </motion.div>
            </div>
          </motion.div>
      ...
      <style>{`
        ...
        @media(max-width:1024px) {
          ...
          .hero-avatar { order: 2 !important; }
        }
        @media(max-width:768px) { .hero-grid { gap: 36px !important; } }
        @media(max-width:480px) {
          .hero-grid { gap: 24px !important; }
          .avatar-badge { display: none !important; }
        }
      `}</style>
    </section>
  );
...
const STATS = [
  ...
  { value: 15, suffix: '+', label: 'APIs Built', icon: Zap },
...
const StatsStrip = () => {
  ...
  return (
    <section ref={ref} style={{
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 40 }} className="stats-grid">
        {STATS.map(({ value, suffix, label, icon: Icon }, i) => (
          ...
          >
            ...
            <div className="font-display" style={{ fontSize: '3.25rem', fontWeight: 500, color: 'var(--cream)', lineHeight: 1, letterSpacing: '-0.02em' }}>
  ...
  const jobs = [
    {
      ...
      location: 'Indore, Madhya Pradesh · Full-time',
      period: 'Jan 2026 – May 2026',
      dark: true,
      bullets: [
        { text: 'Built and maintained 5+ MERN stack and Java Full Stack applications for 500+ active users with JWT authentication and RBAC-based access control', icon: Rocket },
        { text: 'Architected and optimized 15+ RESTful APIs using MongoDB indexing and aggregation pipelines, boosting backend performance by 30%', icon: Database },
        { text: 'Adopted CI/CD pipelines and Agile sprint practices, cutting release cycles by 25% and boosting team delivery output by 15%', icon: Zap },
        { text: 'Implemented JWT + RBAC security architecture, reducing unauthorized access risks by 40%', icon: Shield },
        { text: 'Collaborated in Agile sprints and managed production deployments using Git and GitHub', icon: Terminal },
      ]
    },
    {
      role: 'Web Developer Intern (Paid)',
      company: 'IBM SkillsBuild via Allsoft Solutions',
      location: 'Part-time · Remote',
      period: 'Jan 2026 – May 2026',
      dark: false,
      bullets: [
        { text: 'Developed LaptopKart — a responsive e-commerce platform in React.js with search, filtering, routing, and modular component architecture', icon: ShoppingCart },
        { text: 'Diagnosed and fixed 10+ UI defects through structured component-level testing, increasing application stability score by 20%', icon: Code2 },
        { text: 'Integrated third-party REST APIs for payments and product data, ensuring smooth checkout flow and error handling', icon: Globe },
      ]
    }
  ];
    ...
    <section id="experience" style={{ padding: '100px clamp(24px, 5vw, 80px)' }} ref={containerRef}>
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        ...
        >
          ...
          <h2 className="font-display" style={{ fontSize: 'clamp(2.25rem, 4vw, 3.5rem)', fontWeight: 400, marginTop: 8, letterSpacing: '-0.02em', color: 'var(--ink)' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          {jobs.map((job, ji) => (
            <motion.div
              ...
              animate={isInView ? { opacity: 1, y: 0 } : {}}
              transition={{ duration: 0.7, delay: ji * 0.15 }}
              className="card-grain"
              style={{
                background: job.dark ? 'var(--ink)' : 'var(--surface)',
                borderRadius: 28,
                padding: 'clamp(32px, 4vw, 48px)',
                border: job.dark ? '1px solid rgba(255,255,255,0.06)' : '1px solid var(--border)',
                position: 'relative', overflow: 'hidden'
              }}
            >
              <div style={{ position: 'absolute', top: 0, left: 56, right: 56, height: 2, background: 'linear-gradient(90deg, transparent, var(--gold), transparent)' }} />

              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16, marginBottom: 28 }}>
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
                    <div style={{ width: 40, height: 40, borderRadius: 12, background: 'linear-gradient(135deg, var(--gold-dk), var(--gold))', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                      <Briefcase size={18} style={{ color: 'var(--cream)' }} />
                    </div>
                    <div>
                      <p style={{ fontSize: '0.7rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--gold)', fontFamily: 'DM Mono, monospace' }}>{job.role}</p>
                      <h3 className="font-display" style={{ fontSize: '1.625rem', fontWeight: 500, color: job.dark ? 'var(--cream)' : 'var(--ink)', letterSpacing: '-0.01em' }}>{job.company}</h3>
                    </div>
                  </div>
                  <p style={{ fontSize: '0.8rem', color: job.dark ? 'rgba(247,243,238,0.5)' : 'var(--ink-40)', marginLeft: 52, fontFamily: 'DM Mono, monospace' }}>{job.location}</p>
                </div>
                <div style={{ padding: '6px 16px', borderRadius: 100, border: '1px solid rgba(184,151,90,0.35)', fontSize: '0.75rem', color: 'var(--gold)', fontFamily: 'DM Mono, monospace', letterSpacing: '0.06em', whiteSpace: 'nowrap' }}>
                  {job.period}
                </div>
              </div>

              <div style={{ display: 'grid', gridTemplateColumns: job.bullets.length > 3 ? '1fr 1fr' : '1fr', gap: 12 }} className="exp-grid">
                {job.bullets.map(({ text, icon: Icon }, i) => (
                  <motion.div
                    key={i}
                    initial={{ opacity: 0, x: -16 }}
                    animate={isInView ? { opacity: 1, x: 0 } : {}}
                    transition={{ delay: ji * 0.1 + i * 0.08, duration: 0.5 }}
                    whileHover={{ scale: 1.02, backgroundColor: job.dark ? 'rgba(255,255,255,0.06)' : 'rgba(184,151,90,0.05)' }}
                    style={{
                      display: 'flex', alignItems: 'flex-start', gap: 12,
                      padding: '14px 16px', borderRadius: 12,
                      background: job.dark ? 'rgba(255,255,255,0.04)' : 'rgba(184,151,90,0.04)',
                      border: job.dark ? '1px solid rgba(255,255,255,0.06)' : '1px solid var(--border)',
                      transition: 'transform 0.2s, background-color 0.2s'
                    }}
                  >
                    <Icon size={14} style={{ color: 'var(--gold)', marginTop: 2, flexShrink: 0 }} />
                    <span style={{ fontSize: '0.875rem', color: job.dark ? 'rgba(247,243,238,0.75)' : 'var(--ink-80)', lineHeight: 1.6 }}>{text}</span>
                  </motion.div>
                ))}
              </div>
            </motion.div>
...
const PROJECTS = [
  {
    title: 'Tickvia', subtitle: 'Event Ticket Booking Platform',
    ...
    link: 'https://tickvia.com/', icon: CalendarCheck, accent: '#5B8FD4'
  },
  {
    title: 'LaptopKart', subtitle: 'E-Commerce Platform · IBM Project',
    description: 'Responsive e-commerce platform built during IBM SkillsBuild internship. Features search, filtering, routing, and modular component architecture. Fixed 10+ UI defects via component-level testing, boosting stability by 20%.',
    tech: ['React.js', 'REST APIs', 'Firebase Auth', 'Firestore', 'Responsive Design'],
    link: 'https://laptopkart-git-main-dhanshree-ratnerias-projects.vercel.app/home',
    github: 'https://github.com/Dhanshreeratneria/Laptopkart', icon: ShoppingCart, accent: '#4CAF82'
  },
  {
    title: 'CabnCarry', subtitle: 'Admin Dashboard System',
    description: '8+ admin modules covering vehicle management, fare configuration, trip monitoring, and reporting. Connected 20+ REST APIs for real-time operations and analytics. Reusable UI components accelerated dev speed by 30%.',
    tech: ['React.js', 'Redux Toolkit', 'Tailwind CSS', 'REST APIs', 'Socket.io'], icon: Cpu, accent: '#D4975B'
  },
  {
    title: 'YatraBuddy', subtitle: 'Travel Booking Platform',
    description: 'Full-stack travel booking supporting 10+ service categories. CI/CD pipelines cut deployment time by 78%. Optimized Node.js/Express.js API response times by 30% for critical booking and payment endpoints.',
    tech: ['React.js', 'Node.js', 'Express.js', 'MySQL', 'REST APIs', 'CI/CD'],
    link: 'https://yaatrabuddy.in/', icon: Globe, accent: '#5BC4D4'
  },
  {
    title: 'TerraFlow', subtitle: 'Water Solution Management',
    description: '13+ service request categories including drilling and installations. RBAC for Admin/Customer with Firebase real-time tracking. Streamlined Firestore queries increased system efficiency by 40–50%.',
    tech: ['React.js', 'Firebase Auth', 'Firestore', 'RBAC', 'REST APIs'],
    link: 'https://terraflow-drilling-solution-and-ser.vercel.app',
    github: 'https://github.com/Dhanshreeratneria/Terraflow-Drilling-Solution-and-Services', icon: Package, accent: '#6DB85C'
  },
  {
    title: 'Foodies', subtitle: 'Food Delivery App',
    ...
    tech: ['Node.js', 'MongoDB', 'Express.js', 'REST APIs', 'React.js'], icon: Utensils, accent: '#D45B5B'
  },
  {
    title: 'Hazaribagh Market', subtitle: 'Multi-Vendor Platform',
    ...
    tech: ['React.js', 'REST APIs', 'Admin Dashboard', 'Multi-Vendor'], icon: Package, accent: '#9B5BD4'
  },
  {
    title: 'Spring Boot CRUD', subtitle: 'Backend Architecture',
    description: 'Production-style backend with clean layered architecture — Controller, Service, and Repository. RESTful APIs for efficient CRUD operations using JPA and Hibernate ORM. Improved scalability through clean code practices.',
    tech: ['Java', 'Spring Boot', 'Spring Data JPA', 'MySQL', 'Hibernate', 'MVC'],
    github: 'https://github.com/Dhanshreeratneria/springboot-CRUD-operation', icon: Server, accent: '#D4975B'
  },
  {
    title: 'To-Do Manager', subtitle: 'Task Management App',
    ...
    github: 'https://github.com/Dhanshreeratneria/To-do-Task-manager.git', icon: ClipboardList, accent: '#5BD4B8'
  },
];
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 16 }}>
        <motion.div
          ...
          style={{ width: 44, height: 44, borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid', transition: 'all 0.3s' }}
        >
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          {link && (
            <motion.a href={link} target="_blank" rel="noopener noreferrer"
              ...
              style={{ width: 32, height: 32, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--ink)', color: 'var(--cream)', textDecoration: 'none', transition: 'background-color 0.2s' }}
            >
          ...
          {github && (
            <motion.a href={github} target="_blank" rel="noopener noreferrer"
              ...
              style={{ width: 32, height: 32, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--warm)', color: 'var(--ink)', textDecoration: 'none', transition: 'background-color 0.2s' }}
            >
              <Github size={14} />
            </motion.a>
          )}
      ...
      <p style={{ fontSize: '0.7rem', fontFamily: 'DM Mono, monospace', color: accent, letterSpacing: '0.08em', marginBottom: 6, textTransform: 'uppercase' }}>{subtitle}</p>
      <h3 className="font-display" style={{ fontSize: '1.5rem', fontWeight: 500, color: 'var(--ink)', marginBottom: 10, letterSpacing: '-0.01em' }}>{title}</h3>
      <p style={{ fontSize: '0.85rem', color: 'var(--ink-80)', lineHeight: 1.7, marginBottom: 20, flex: 1, fontWeight: 300 }}>{description}</p>
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
        {tech.map(t => <span key={t} className="tag-pill" style={{ fontSize: '0.625rem' }}>{t}</span>)}
      </div>
    </motion.div>
  );
};
...
const SKILL_CATS = [
  {
    ...
    skills: [
      ...
      { name: 'TypeScript', img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/typescript/typescript-original.svg', desc: 'Typed JavaScript for scalable applications' },
      { name: 'Go', img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/go/go-original.svg', desc: 'Concurrent, statically-typed backend services' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Go (Golang)', img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/go/go-original.svg', desc: 'Lightweight, high-performance API services' },
    ]
  },
  {
    ...
    skills: [
      ...
      { name: 'DBMS Fundamentals', img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg', desc: 'Normalization, transactions, schema design' },
    ]
  },
  {
    category: 'Cloud & DevOps', icon: Shield,
    skills: [
      { name: 'CI/CD Pipelines', img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg', desc: 'Automated build, test and deploy workflows' },
      { name: 'Firebase', img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/firebase/firebase-plain.svg', desc: 'Cloud hosting, auth, and Firestore' },
      { name: 'Vercel', img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg', desc: 'Frontend deployment and serverless functions' },
    ]
  },
  {
    category: 'Concepts & Tools', icon: Wrench,
    skills: [
      { name: 'REST APIs / JWT', img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/fastapi/fastapi-original.svg', desc: 'RESTful design, token-based auth' },
      { name: 'RBAC / DSA / OOP', img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg', desc: 'Role-based access, data structures, OOP' },
      { name: 'SDLC / Agile / MVC', img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/trello/trello-plain.svg', desc: 'Software lifecycle, sprint delivery, MVC architecture' },
      { name: 'Unit Testing', img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/jest/jest-plain.svg', desc: 'Component-level testing and debugging' },
      { name: 'Git & GitHub', img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg', desc: 'Version control, branching, code review' },
...
const SkillCard = ({ category, icon: Icon, skills, index }) => {
  ...
  return (
    <motion.div
      ...
      className="card-grain"
      style={{ background: 'var(--surface)', borderRadius: 20, border: '1px solid var(--border)', overflow: 'hidden', transition: 'transform 0.3s, box-shadow 0.3s' }}
    >
      <div style={{ padding: '20px 24px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: 10, background: 'linear-gradient(135deg, rgba(184,151,90,0.06), transparent)' }}>
        <div style={{ width: 32, height: 32, borderRadius: 8, background: 'linear-gradient(135deg, var(--gold-dk), var(--gold))', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ padding: '16px 24px 24px' }}>
        {skills.map((skill, i) => (
          <motion.div
            ...
            style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '10px 12px', borderRadius: 10, marginBottom: 4, transition: 'all 0.2s ease', cursor: 'default' }}
          >
            <img
...
const Skills = () => (
  <section id="skills" style={{ padding: '100px clamp(24px, 5vw, 80px)', background: 'var(--warm)', position: 'relative' }}>
    <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundImage: 'radial-gradient(var(--border-strong) 1px, transparent 1px)', backgroundSize: '32px 32px', opacity: 0.5, pointerEvents: 'none' }} />
    <div style={{ maxWidth: 1280, margin: '0 auto', position: 'relative', zIndex: 1 }}>
      ...
      >
        ...
        <h2 className="font-display" style={{ fontSize: 'clamp(2.25rem, 4vw, 3.5rem)', fontWeight: 500, marginTop: 8, letterSpacing: '-0.02em', color: 'var(--ink)' }}>
...
/* ─── Achievements + Certs ──────────────────────────────────────────────── */
const ACHIEVEMENTS = [
  { text: 'Top 20 Finalist among 100+ teams at Void Hack 6.0 Hackathon', icon: Trophy },
  { text: 'Improved task execution speed by 30% at Void Hack 5.0 through API optimization', icon: Zap },
  { text: 'Ranked 8th in college in Data Structures, OOP, and C Programming', icon: Star },
];
...
const CORE_COMPETENCIES = [
  ...
  { text: 'Technical Communication', icon: MessageSquare },
  { text: 'System Design', icon: LayoutGrid },
  { text: 'Responsive Design', icon: Layout },
];
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 28 }} className="ach-grid">
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          <motion.div
            ...
            style={{ background: 'var(--ink)', borderRadius: 20, padding: '32px', border: '1px solid rgba(255,255,255,0.06)', position: 'relative', overflow: 'hidden' }}
          >
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.02 }}
            style={{ background: 'linear-gradient(135deg, var(--gold-dk), var(--gold))', borderRadius: 20, padding: '32px' }}
          >
            ...
            <p style={{ fontSize: '0.875rem', color: 'rgba(247,243,238,0.9)', lineHeight: 1.6, marginBottom: 8 }}>
              Shri Vaishnav Vidyapeeth Vishwavidyalaya, Indore
            </p>
            <p style={{ fontSize: '0.8rem', color: 'rgba(247,243,238,0.75)', lineHeight: 1.5, marginBottom: 16 }}>
              Class XII · Bharat Bal Vinay Mandir HSS · 84%
            </p>
            <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
              <span style={{ background: 'rgba(255,255,255,0.2)', color: 'var(--cream)', padding: '4px 14px', borderRadius: 100, fontSize: '0.75rem', fontFamily: 'DM Mono, monospace' }}>CGPA: 7.95/10</span>
              <span style={{ background: 'rgba(255,255,255,0.2)', color: 'var(--cream)', padding: '4px 14px', borderRadius: 100, fontSize: '0.75rem', fontFamily: 'DM Mono, monospace' }}>Passout 2026</span>
            </div>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="card-grain"
          style={{ background: 'var(--surface)', borderRadius: 20, border: '1px solid var(--border)', padding: '32px', display: 'flex', flexDirection: 'column' }}
        >
          ...
          <div style={{ flex: 1 }}>
            {CERTS.map((cert, i) => (
              <motion.div
                ...
                whileHover={{ backgroundColor: 'rgba(184,151,90,0.05)', paddingLeft: 20 }}
                style={{ display: 'flex', alignItems: 'flex-start', gap: 12, padding: '12px 12px', borderRadius: 10, borderBottom: i < CERTS.length - 1 ? '1px solid var(--border)' : 'none', transition: 'all 0.2s' }}
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <p style={{ fontSize: '0.75rem', color: 'var(--ink-40)', marginTop: 3, fontFamily: 'DM Mono, monospace' }}>{cert.issuer} · {cert.date}</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div style={{ marginTop: 24, paddingTop: 20, borderTop: '1px solid var(--border)' }}>
            <p style={{ fontSize: '0.7rem', fontFamily: 'DM Mono, monospace', color: 'var(--gold)', letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: 14 }}>Core Competencies</p>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10 }}>
              {CORE_COMPETENCIES.map(({ text, icon: Icon }, i) => (
                <motion.span
                  key={i}
                  initial={{ opacity: 0, y: 8 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.08 }}
                  whileHover={{ backgroundColor: 'var(--gold)', color: 'var(--cream)', borderColor: 'var(--gold)' }}
                  className="tag-pill"
                  style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: '0.72rem', padding: '6px 14px' }}
                >
                  <Icon size={12} /> {text}
                </motion.span>
              ))}
...
const CONTACT_DETAILS = [
  ...
  { icon: Star, label: 'CGPA', value: '7.95 / 10.0' },
];

const ContactModal = ({ onClose }) => (
  <motion.div
    initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
    style={{ position: 'fixed', inset: 0, zIndex: 200, background: 'rgba(13,13,13,0.7)', backdropFilter: 'blur(12px)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', overflowY: 'auto' }}
  ...
  >
    <motion.div
      ...
      className="card-grain"
      style={{ background: 'var(--cream)', borderRadius: 28, width: '100%', maxWidth: 720, border: '1px solid var(--border-strong)', overflow: 'hidden', maxHeight: '90vh', overflowY: 'auto' }}
    >
      <div style={{ padding: '32px 40px 28px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'var(--ink)', position: 'sticky', top: 0, zIndex: 1 }}>
        <div>
          <p className="section-eyebrow" style={{ marginBottom: 4, color: 'var(--gold-lt)' }}>Let's Connect</p>
          <h2 className="font-display" style={{ fontSize: '2rem', fontWeight: 400, color: 'var(--cream)', letterSpacing: '-0.02em' }}>Contact &amp; Details</h2>
        </div>
        <motion.button
          onClick={onClose}
          whileHover={{ scale: 1.1, rotate: 90, background: 'var(--gold)' }}
          style={{ width: 40, height: 40, borderRadius: '50%', background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', color: 'var(--cream)', transition: 'all 0.2s' }}
        >
          <X size={16} />
        </motion.button>
      </div>
      ...
      <div style={{ padding: '32px 40px 40px' }}>
        <div className="contact-details-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 28 }}>
          {CONTACT_DETAILS.map((d, i) => {
            const Icon = d.icon;
            return (
              <motion.div
                key={i} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.06 }}
                whileHover={{ scale: 1.02, boxShadow: '0 8px 20px rgba(0,0,0,0.05)' }}
                style={{ background: 'var(--surface)', borderRadius: 14, padding: '16px 18px', border: '1px solid var(--border)' }}
              >
                ...
                {d.link ? (
                  <a href={d.link} target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.85rem', fontWeight: 500, color: 'var(--ink)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 4 }}>
        ...
        <div style={{ background: 'var(--ink)', borderRadius: 16, padding: '28px 32px', marginBottom: 16, position: 'relative', overflow: 'hidden' }}>
          ...
          <p style={{ fontSize: '0.875rem', color: 'rgba(247,243,238,0.7)', lineHeight: 1.75, marginBottom: 16, fontWeight: 300 }}>
            Full Stack Developer with hands-on experience in end-to-end web application development using React.js, Node.js, Spring
            Boot, Go, and CI/CD workflows. Experienced delivering production-grade systems across e-commerce, travel booking, and
            service management domains. Skilled in authentication (JWT, RBAC), REST APIs, database optimization, and responsive UI
            development, with strong fundamentals in DSA, OOP, DBMS, and Agile/SDLC practices. Passionate about clean architecture
            and production-ready solutions.
          </p>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            {['MERN Stack', 'Spring Boot', 'Go', 'JWT/RBAC', 'REST APIs', 'CI/CD', 'TypeScript', 'MongoDB', 'React.js'].map(tag => (
        ...
        <div style={{ background: 'var(--surface)', borderRadius: 14, padding: '20px 24px', border: '1px solid var(--border)', display: 'flex', alignItems: 'flex-start', gap: 12, marginBottom: 16 }}>
        ...
        <div style={{ background: 'var(--surface)', borderRadius: 14, padding: '20px 24px', border: '1px solid var(--border)' }}>
          <p style={{ fontSize: '0.7rem', fontFamily: 'DM Mono, monospace', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--ink-40)', marginBottom: 10 }}>Core Competencies</p>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
            {['Team Collaboration', 'Technical Communication', 'System Design', 'Responsive Design'].map(tag => (
        ...
        <style>{`@media(max-width:480px){ .contact-details-grid { grid-template-columns: 1fr !important; } }`}</style>
      </div>
    </motion.div>
  </motion.div>
);
    ...
    <div style={{ maxWidth: 1280, margin: '0 auto' }}>
      <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', flexWrap: 'wrap', gap: 32, marginBottom: 40 }}>
        <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
          ...
          <p style={{ fontSize: '0.85rem', color: 'rgba(247,243,238,0.4)', marginTop: 10, fontWeight: 300 }}>Full-Stack Developer · Indore, India</p>
        </motion.div>
        <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
          {[
            ...
            <motion.a key={label} href={href} target={href.startsWith('mailto') ? undefined : '_blank'} rel="noopener noreferrer"
              ...
              style={{ width: 44, height: 44, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(255,255,255,0.12)', color: 'rgba(247,243,238,0.6)', textDecoration: 'none', transition: 'all 0.2s' }}
            >
              <Icon size={16} />
            </motion.a>
          ))}
          <motion.button onClick={onContact}
            ...
            whileTap={{ scale: 0.97 }}
            style={{ background: 'linear-gradient(135deg, var(--gold-dk), var(--gold))', color: 'var(--cream)', border: 'none', borderRadius: 100, padding: '0.75rem 1.5rem', fontSize: '0.75rem', letterSpacing: '0.08em', fontWeight: 600, textTransform: 'uppercase', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 8 }}
          >
